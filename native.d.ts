...
export class AltJTalk {
  ...
  prepare(inputText: string, option: SynthesisOption): Promise<ExternalObject<PreparedSynthesizer>>
  synthesize(synthesizer: ExternalObject<PreparedSynthesizer>, push: (...args: [err: null, frame: Buffer] | [err: Error, frame: null]) => void): Promise<void>
}
